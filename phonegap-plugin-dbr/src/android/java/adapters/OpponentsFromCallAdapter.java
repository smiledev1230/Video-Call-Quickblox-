...
import qb.utils.QBRTCSessionUtils;
...
public class OpponentsFromCallAdapter extends RecyclerView.Adapter<OpponentsFromCallAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        int list_item_opponent_from_call =
                context.getResources().getIdentifier("list_item_opponent_from_call", "layout", context.getPackageName());
        int innerLayout =
                context.getResources().getIdentifier("innerLayout", "id", context.getPackageName());
        View v = inflater.inflate(list_item_opponent_from_call, null);
        v.findViewById(innerLayout).setLayoutParams(new FrameLayout.LayoutParams(itemWidth, itemHeight));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            opponentsName = (TextView) itemView.findViewById(getIdIdentifier("opponentName"));
            connectionStatus = (TextView) itemView.findViewById(getIdIdentifier("connectionStatus"));
            opponentView = (QBRTCSurfaceView) itemView.findViewById(getIdIdentifier("opponentView"));
            progressBar = (ProgressBar) itemView.findViewById(getIdIdentifier("progress_bar_adapter"));
        }
        ...
        public int getIdIdentifier(String res){
            return itemView.getResources().getIdentifier(res, "id", itemView.getContext().getPackageName());
        }
    }
