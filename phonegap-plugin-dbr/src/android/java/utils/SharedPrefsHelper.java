...
public class SharedPrefsHelper extends CordovaPlugin{
    private static final String SHARED_PREFS_NAME = "qb_plugin";
    ...
    private SharedPrefsHelper() {
        instance = this;
        this.sharedPreferences = QBBase.getInstance().getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE);
    }
