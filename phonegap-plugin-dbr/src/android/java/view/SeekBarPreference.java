...
public class SeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public SeekBarPreference(Context context, AttributeSet attrs, int defStyle) {
        ...
        int layout = getContext().getResources().getIdentifier("seekbar_preference", "layout", getContext().getPackageName());
    ...
    private void initFields(Context context, AttributeSet attrs) {
        int pref_default_int_value = getContext().getResources().getIdentifier("pref_default_int_value", "integer", getContext().getPackageName());
        int maxValueResourceId = attrs.getAttributeResourceValue(ANDROID_NS, "max", pref_default_int_value);
        maxSeekBarValue = context.getResources().getInteger(maxValueResourceId);

        int minValueResourceId = attrs.getAttributeResourceValue(SEEKBAR_NS, "min", pref_default_int_value);
        minSeekBarValue = context.getResources().getInteger(minValueResourceId);

        int stepSizeValueResourceId = attrs.getAttributeResourceValue(SEEKBAR_NS, "stepSize", pref_default_int_value);
    ...
    protected void onBindView(View view) {
        ...
        int seekbar = getContext().getResources().getIdentifier("seekbar", "id", getContext().getPackageName());
