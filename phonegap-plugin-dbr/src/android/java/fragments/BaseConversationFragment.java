...
public abstract class BaseConversationFragment extends BaseToolBarFragment implements CallActivity.CurrentCallStateCallback {
    ...
    protected void initViews(View view) {
        micToggleVideoCall = (ToggleButton) view.findViewById(getIdIdentifier("toggle_mic"));
        handUpVideoCall = (ImageButton) view.findViewById(getIdIdentifier("button_hangup_call"));
        outgoingOpponentsRelativeLayout = view.findViewById(getIdIdentifier("layout_background_outgoing_screen"));
        allOpponentsTextView = (TextView) view.findViewById(getIdIdentifier("text_outgoing_opponents_names"));
        ringingTextView = (TextView) view.findViewById(getIdIdentifier("text_ringing"));
