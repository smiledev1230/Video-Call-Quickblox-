...
BarcodeScanner.prototype.loginQB = function (successCallback, user) {
    exec(successCallback, function () { }, 'Login', 'loginQB', [user]);
};

BarcodeScanner.prototype.getUsersQB = function (successCallback, errorCallback, user) {
    exec(successCallback, errorCallback, 'BarcodeScanner', 'getUsersQB', [user]);
};
